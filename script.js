(function () {
  ...
  var PROJECTS = {
    marksheet: {
      ...
      shots: [
        { label: "Select term & class", img: "images/marksheet-select-term.jpg" },
        { label: "Digital marksheet view", img: "images/marksheet-result.jpg" },
        { label: "Enter roll number", img: "images/marksheet-roll-entry.jpg" },
      ],
      highlights:
    ...
    certificate: {
      ...
      tech: ["Google Sheets", "Google Apps Script", "HTML", "CSS", "JavaScript"],
      shots: [
        { label: "Home — Student Portal", img: "images/cert-home.jpg" },
        { label: "Certificate status check", img: "images/cert-status-check.jpg" },
        { label: "Admin login", img: "images/cert-admin-login.jpg" },
        { label: "Admin dashboard", img: "images/cert-admin-dashboard.jpg" },
      ],
      highlights:
    ...
    mcq: {
      ...
      tech: ["Google Sheets", "Google Apps Script", "HTML", "CSS", "JavaScript"],
      shots: [
        { label: "Admin login", img: "images/mcq-admin-login.jpg" },
        { label: "Live control panel", img: "images/mcq-live-control.jpg" },
        { label: "Join competition", img: "images/mcq-join.jpg" },
      ],
      highlights:
