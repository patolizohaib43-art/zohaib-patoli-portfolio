(function () {
  ...
  var PROJECTS = {
    marksheet: {
      ...
      shots: ["Result lookup screen", "Digital marksheet view", "Admin data sheet"],
      highlights:
    ...
    certificate: {
      ...
      tech: ["Google Sheets", "Google Apps Script", "HTML", "CSS", "JavaScript"],
      shots: ["Application form", "Status tracker", "Approved certificate", "Download screen"],
      highlights:
    ...
    mcq: {
      ...
      tech: ["Google Sheets", "Google Apps Script", "HTML", "CSS", "JavaScript"],
      shots: ["Live question screen", "Leaderboard display", "Admin control panel"],
      highlights:
  ...
  function renderProject(key) {
    var p = PROJECTS[key];
    if (!p) return;
    var shotsHTML = p.shots
      .map(function (label) {
        return '<div class="m-shot">' + label + "</div>";
      })
      .join("");
